!function (t, e) {
    ...
    var P, L = function (t) {
        ...
        at = function (t) {
            ...
            var e, n, o, i, r = X();
            S(r, t.customClass, "header"), mt(t), function (t) {
                var e = z();
                if (e && e.classList.contains(g[t.type])) S(e, t.customClass, "icon"); else if (pt(), t.type) if (ft(), -1 !== Object.keys(g).indexOf(t.type)) {
            ...
            var e, n, o, i;
            e = t, n = U(), V(n, "width", e.width), V(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = x.popup, e.toast ? (O([document.documentElement, document.body], x["toast-shown"]), O(n, x.toast)) : O(n, x.modal), S(n, e.customClass, "popup"), "string" == typeof e.customClass && O(n, e.customClass), E(n, x.noanimation, !e.animation), function (t) {
                var e = R();
                if (e) {
    ...
    var vt = [], bt = function () {
        ...
        }), Lt = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap};
    ...
    function Rt(t, e) {
        ot() ? Ut(e) : (wt().then(function () {
            return Ut(e)
        }), yt.keydownTarget.removeEventListener("keydown", yt.keydownHandler, {capture: yt.keydownListenerCapture}), yt.keydownHandlerAdded = !1), t.parentNode && t.parentNode.removeChild(t), T([document.documentElement, document.body], [x.shown, x["height-auto"], x["no-backdrop"], x["toast-shown"], x["toast-column"]]), nt() && (Tt(), Mt(), qt(), Ht())
    }
    ...
    function Dt(t) {
        var e = R(), n = U(), o = Lt.innerParams.get(this), i = It.swalPromiseResolve.get(this), r = o.onClose,
            a = o.onAfterClose;
    ...
    var Qt, Yt = Object.freeze({
        hideLoading: Et, disableLoading: Et, getInput: function (t) {
            var e = Lt.innerParams.get(t || this);
            return A(Lt.domCache.get(t || this).content, e.input)
        }, close: Dt, closePopup: Dt, closeModal: Dt, closeToast: Dt, enableButtons: function () {
            ...
            return new Promise(function (t) {
                ...
                if (yt.keydownHandlerAdded && (yt.keydownTarget.removeEventListener("keydown", yt.keydownHandler, {capture: yt.keydownListenerCapture}), yt.keydownHandlerAdded = !1), f.toast || (yt.keydownHandler = function (t) {
                    return function (t, e) {
